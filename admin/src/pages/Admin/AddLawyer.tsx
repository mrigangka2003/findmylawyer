...
const AddLawyer: React.FC = () => {
  ...
  const experienceOptions: number[] = Array.from({ length: 60 }, (_, i) => i + 1);
    ...
    <div className="min-h-screen text-white py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">Add a New Lawyer</h1>
          <p className="text-gray-400 text-lg">
            Empower justice by connecting skilled lawyers with those who need them most.
          </p>
        </div>
        ...
        >
          ...
          <div className="md:col-span-2">
            <label className="flex items-center gap-2 text-sm mb-2">
              <FileText className="w-4 h-4" /> About Me
            </label>
            <textarea
              {...register("aboutMe")}
              rows={4}
